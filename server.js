...
app.use(function (req, res, next) { //Parametr next, który przekazujemy do funkcji jest funkcją, która pozwala “iść dalej" do kolejnej funkcji middleware lub zakończenia żądania.
    res.status(404).send('Wybacz, nie mogliśmy odnaleźć tego, czego żądasz!')
});

// app.get('/:id', function (req, res) { //odwołać się do strony domowej ///('/')
//     console.log('Otrzymałem żądanie GET do strony głównej');
